...
export const FAKE_EXPLORE_RECORDS = [
  {
    ...
    records: [{
      ...
      files: ['https://picsum.photos/seed/climb1/600/400.jpg'],
      likes: 12, likedBy: [],
  ...
  },
  {
    ...
    records: [{
      ...
      files: ['https://picsum.photos/seed/climb2/600/400.jpg'],
      likes: 8, likedBy: [],
  ...
  },
  {
    ...
    records: [{
      ...
      files: ['https://picsum.photos/seed/climb3/600/400.jpg'],
      likes: 21, likedBy: [],
  ...
  },
  {
    ...
    records: [{
      ...
      files: ['https://picsum.photos/seed/climb4/600/400.jpg'],
      likes: 5, likedBy: [],
      comments: [],
    }],
  },
    ...
    records: [
      {
        ...
        memo: '完攀成功！太開心了 🎉',
        files: ['https://picsum.photos/seed/myClimb1/300/200.jpg'],
      },
